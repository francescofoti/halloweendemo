...
#If Win64 Then
  Private Const CONSOUL_DLL_NAME As String = "consoul_010205_64.dll"
#Else
  Private Const CONSOUL_DLL_NAME As String = "consoul_010205_32.dll"
#End If
...
Public Function FindConsoulLibrary() As Boolean
  ...
  If fOK Then
    ...
    'Force Access to immediately load the DLL
    'If an error occurs we'll fall to FindConsoulLibrary_Err
    Dim oConsole  As CConsoul
    Dim sVersion  As String
    Set oConsole = New CConsoul
    sVersion = oConsole.ConsoulVersion
